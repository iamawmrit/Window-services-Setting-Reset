:: Batch Script Created by Awmrit.
...
Echo.
Echo Press 'ENTER' Key To Reboot System. And Don't Forget to thanks to Amrit Adhikari the Super!
Echo Follow me on instagram @iamawmrit Facebook @iamawmrit/@awmrit
Pause >Nul
